public class desperet {
    public static void main(String[] args) {
        ...
        // arkadaşlar byte +127 ye kadardır. manuel daraltmalarda sınır aşıldığında eksi rakamından başlayak asilan rakam kadar
        // rakam ilerler.
        // +129 rakamını byte'a manuel olarak daraltırsak 129-127=2 bu iki rakamı byt'in en dusuk limitinden yukari dogru
